const Card4 = () => {
    return (
        <div className="w-full max-w-[600px] px-4">
            ...
            <div className="relative group flex min-h-[21rem] w-full rounded-[2rem] bg-[#A88964] text-white overflow-visible">
                <div className="absolute right-[-5%] bottom-[-10%] w-[45%] h-auto z-10 select-none pointer-events-none">
                    <img
