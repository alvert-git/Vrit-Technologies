const Card1 = () => {
    return (
        <div className="w-full max-w-[600px] px-4 md:px-0">
            ...
            <div className="relative group flex min-h-[21rem] w-full rounded-[2rem] bg-[#F45B5B] text-white overflow-visible">

                <div className="absolute left-[-10%] w-[55%] h-auto z-10 select-none pointer-events-none">
                    <img
                ...
                <div className="flex flex-col justify-center ml-auto w-[65%] md:w-[60%] pr-10 pl-4 py-8 text-right z-20">
